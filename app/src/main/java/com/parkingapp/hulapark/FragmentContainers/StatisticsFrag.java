 ...
 * Use the {@link StatisticsFrag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class StatisticsFrag extends Fragment implements IActiveUserFragSetter
{
     ...
     * @return A new instance of fragment StatisticsFrag.
     */
    // TODO: Rename and change types and number of parameters
    public static StatisticsFrag newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        CommonFragUtils.FragmentSwapper.getUserType().observe(getViewLifecycleOwner(), userType -> {
            setActiveUserFrag(userType, view, R.id.statistcsFragContainer);
        });
