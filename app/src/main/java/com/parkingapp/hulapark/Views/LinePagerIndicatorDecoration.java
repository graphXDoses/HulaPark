...
public class LinePagerIndicatorDecoration extends RecyclerView.ItemDecoration {
    ...
    private int colorActive = 0xFF0000FF;
    private int colorInactive = 0x000000FF;
    ...
    public LinePagerIndicatorDecoration(Resources resources)
    {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        // float indicatorPosY = (parent.getY() + (parent.getHeight() / 2F)) - mIndicatorHeight / 2F;
    ...
    private void drawInactiveIndicators(Canvas c, float indicatorStartX, float indicatorPosY, int itemCount) {
        mPaint.setColor(resources.getColor(R.color.gray_400));
