...
public class CurvedBottomNavigationView extends BottomNavigationView
{
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null)
        {
            ...
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.CurvedBottomNavigationView);
            mPaint.setColor(typedArray.getColor(R.styleable.CurvedBottomNavigationView_exampleColor, resources.getColor(R.color.green_leaf)));
